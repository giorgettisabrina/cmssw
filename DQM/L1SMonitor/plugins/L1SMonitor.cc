// -*- C++ -*-
//
// Package:    DQM/L1SMonitor
// Class:      L1SMonitor
//
/**\class L1SMonitor L1SMonitor.cc DQM/L1SMonitor/plugins/L1SMonitor.cc
...
#include "DQM/L1SMonitor/plugins/L1SMonitor.h"

// constructors and destructor
L1SMonitor::L1SMonitor(const edm::ParameterSet& iConfig)
...
L1SMonitor::~L1SMonitor() {
}

// Implementations of virtual functions
void L1SMonitor::bookHistograms(DQMStore::IBooker& ibook,
                                edm::Run const& run,
...
void L1SMonitor::dqmAnalyze(edm::Event const& iEvent,
                            edm::EventSetup const& iSetup,
...
void L1SMonitor::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
