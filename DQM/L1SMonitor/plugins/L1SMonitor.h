...
// Class:      L1SMonitor
//
/**\class L1SMonitor L1SMonitor.h DQM/L1SMonitor/plugins/L1SMonitor.h
...
#ifndef DQM_L1SMonitor_L1SMonitor_h
#define DQM_L1SMonitor_L1SMonitor_h
...
class L1SMonitor : public DQMGlobalEDAnalyzer<Histograms> {
public:
  explicit L1SMonitor(const edm::ParameterSet&);
  ~L1SMonitor() override;
