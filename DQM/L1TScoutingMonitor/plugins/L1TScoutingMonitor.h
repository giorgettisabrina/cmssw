...
//
/**\class L1TScoutingMonitor L1TScoutingMonitor.h DQM/L1TScoutingMonitor/plugins/L1TScoutingMonitor.h
...
#ifndef DQM_L1TScoutingMonitor_L1TScoutingMonitor_h
#define DQM_L1TScoutingMonitor_L1TScoutingMonitor_h
...
class L1TScoutingMonitor : public DQMGlobalEDAnalyzer<Histograms> {
public:
  explicit L1TScoutingMonitor(const edm::ParameterSet&);
  ~L1TScoutingMonitor() override;
